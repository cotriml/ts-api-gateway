...
const mockRequest = (): HttpPutController.Request => {
  return {
...
const makeSut = (): SutTypes => {
  ...
  const sut = new HttpPutController(loadServiceByBaseUrlSpy, callServiceByHttpSpy)
  return {
    sut,
