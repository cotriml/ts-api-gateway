...
const mockRequest = (): HttpPostController.Request => {
  return {
...
const makeSut = (): SutTypes => {
  ...
  const sut = new HttpPostController(loadServiceByBaseUrlSpy, callServiceByHttpSpy)
  return {
    sut,
