...
const mockRequest = (): HttpPatchController.Request => {
  return {
...
const makeSut = (): SutTypes => {
  ...
  const sut = new HttpPatchController(loadServiceByBaseUrlSpy, callServiceByHttpSpy)
  return {
    sut,
